...
const questions = [
  ...
  {
    q: "Which of the following is the correct syntax to display “I am a Winner” in an alert box using JavaScript?",
    answers: [
      "alertbox(“I am a Winner”);",
      "msg(“I am a Winner”)",
      "msgbox(“I am a Winner”);",
      "alert(“I am a Winner”)",
    ],
    correctAnswer: "alert(“I am a Winner”);",
  },
 
  {
    q:
      "What is the correct syntax for referring to an external script called “winner.js”?",
    answers: [
      "<script src=”winner.js”>",
      "Html.js",
      "winner.js",
      "None of the Above",
    ],
    correctAnswer: "<script src=”winner.js”>",
  },
  
  {
    q: "______ JavaScript is also called client-side JavaScript.",
    answers: ["Quantum Entangler", "Navigator", "Operating System", "Native"],
    correctAnswer: "Navigator",
  },
  {
    q: "__________ JavaScript is also called server-side JavaScript.",
    answers: ["Netscape", "Navigator", "LiveWire", "TARDIS"],
  ...
  for (let i = 0; i < currentQ.answers.length; i++) {
    ...
    selectButton.onclick = function () {
      if (currentQ.correctAnswer.includes(currentQ.answers[i])) {
        score++;
        answerCheck.textContent = "CORRRECT!!! HOORAY!";
        ...
        answerCheck.textContent = "Wrong, That's Wrong, Okay.";
        answerCheckDiv.appendChild(answerCheck);
        console.log(score);
        quiz();
      }
